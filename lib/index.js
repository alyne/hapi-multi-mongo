...
exports.plugin = {
    ...
    async register(server, options) {
        ...
        const uris = [].concat(options.connection);
        ...
        const makeConnectionObject = (conf) => {
            ...
            // following line of code will fix the depracation warning, but break a test that I have no idea how to fix
            // official release note mentions useUnifiedTopology: https://github.com/mongodb/node-mongodb-native/releases
            // connObj.options = Object.assign({ useUnifiedTopology: true }, globalOptions, connObj.options);
            return connObj;
        };
        ...
        const connect = async (uri) => {
            ...
            connections[connectionObj.name] = connection.db(uriMatch.defaultDatabase);
